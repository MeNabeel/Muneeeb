  ...
  return (
    <section id="work" className="py-24 bg-[#0B0F0E] relative">
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        {/* Section Header */}
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6 border-b border-[rgba(143,211,199,0.15)] pb-8">
          <div>
          ...
          >
            <TabsList className="flex-wrap h-auto bg-[#111917] p-1 border border-[rgba(143,211,199,0.18)]">
              {categories.map((cat) => (
        ...
        {filteredProjects.length === 0 && (
          <div className="text-center py-16 border border-dashed border-[rgba(143,211,199,0.2)] bg-[#111917]/50">
